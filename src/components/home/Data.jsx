...
const Data = () => {
  return (
    <div className="home_data">
      <h1 className="home_title">Prajwal Chaudhary
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className="home_description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto praesentium quibusdam quis quae quisquam! Illo ab labore nihil error odio, ex nostrum animi reiciendis.</p>
